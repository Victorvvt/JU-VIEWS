          ...
          <div class="navbar-nav ms-auto">
            <div class="dropdown-center">
              <button class="btn  btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                <?php echo "Usuario <strong class='text-info'>" . $_SESSION['nombre'] . "</strong> conectado"; ?>
              </button>
              <a id="cerradosesion" href="inicio.php" class="dropdown-menu btn btn-primary text-center rounded-3 w-25">Cerrar sesión</a>
            </div>
            <a class="nav-link active" href="./peliculas/index-usuarios.php">Películas</a>
            <a class="nav-link active" href="./series/index-usuarios.php">Series</a>
          </div>
