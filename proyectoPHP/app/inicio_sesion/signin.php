                ...
                <h1 id="title" class="navbar-brand"><i class="bi bi-play-circle-fill"></i> JuViews</h1>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                        <div class="navbar-nav ms-auto">
                            ...
                            <a href="login.php" class="nav-link  btn btn-primary m-2 p-2">LogIn</a>
    ...
    <div class="container-fluid my-5 p-5">
        ...
        <div class="row ">
            <div class="col-12 d-flex justify-content-center ">
                <form class="row card p-4" method="post">
                    <h2 class="text-center">Regístrate</h2>
                    <?php include "controlador-signin.php" ?>
                    ...
                    <button name="btn-signin" class="btn btn-primary mt-3" type="submit">Registrarse</button>
                    <a href="signin.php" class="nav-link mt-3">Inicio sesión</a>
                </form>
                </form>
            </div>
        </div>
